...
class UserPageRenderingTest {
    ...
    void profilePageRendersRealtimeEligibilityUiAndStaticScript() throws Exception {
        ...
        assertThat(response.body())
                ...
                .contains("data-auto-save-field=\"graduationDate\"")
                .contains("data-auto-save-field=\"employmentType\"")
                .contains("data-auto-save-field=\"smeEmployee\"")
                .contains("data-auto-save-field=\"jobSeekingStatus\"")
                .contains("data-profile-field=\"GRADUATION_DATE\"")
                .contains("data-profile-field=\"EMPLOYMENT_TYPE\"")
                .contains("data-profile-field=\"SME_EMPLOYEE\"")
                .contains("data-profile-field=\"JOB_SEEKING_STATUS\"")
                .contains("추가 정책 확인을 위한 정보")
